...
<div flex ng-cloak class="content" id="testgrid" data-ng-init="init()">
	...
	<md-grid-list id="content-list" md-cols-sm="1" md-cols-md="2" md-cols-lg="3" md-cols-gt-lg="4" md-row-height="200px" class="content-grid"
		md-gutter="30"> <md-grid-tile data-ng-repeat="result in results" class="grid-item md-whiteframe-z4 tile{{$index%7}}" ng-click="showDetails($index,$event);">
